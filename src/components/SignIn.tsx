...
const SignIn: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // If there's a UID in the URL, redirect to signup
    if (uid) {
      console.log(`Found UID in URL: ${uid}. Redirecting to signup...`);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Sign in to Omira</CardTitle>
